...
public class Futbolista implements Comparable<Futbolista> {
	...
	// Dos futbolistas son iguales si coinciden camiseta Y nombre
	@Override
	...
	// Orden: primero por camiseta; si empatan, por nombre alfabéticamente
	@Override
	...
	public String toString() {
		return "Futbolista [camiseta=" + numeroCamiseta + ", nombre=" + nombre + ", edad=" + edad + ", goles=" + goles
				+ "]";
	}
}